...
import { Clock, Target, TrendingUp, Lightbulb, ArrowRight, RotateCcw } from 'lucide-react'
import {
  ...
  return (
    <>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              title="Clear personalized recommendations"
            >
      ...
      <AlertDialog open={showClearConfirmation} onOpenChange={setShowClearConfirmation}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Clear Personalized Recommendations?</AlertDialogTitle>
            <AlertDialogDescription>
              This will reset your organization profile and recommendations. You will need to set up your profile again
              to receive personalized guidance.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleClearRecommendations}>Clear Recommendations</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </>

    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Upload your completed Cyber Essentials questionnaire spreadsheet or paste individual questions to receive an automated assessment.
        </p>
      </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              ...
              <ol className="space-y-2 text-sm text-gray-700">
                <li className="flex gap-3">
                  ...
                  <span>Upload your completed Cyber Essentials questionnaire spreadsheet (XLSX, XLS, or CSV format)</span>
                </li>
                <li className="flex gap-3">
          ...
          <div className="mt-8 max-w-2xl mx-auto">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              ...
              <ol className="space-y-2 text-sm text-gray-700">
                <li className="flex gap-3">
                  <span className="font-medium text-blue-600">1.</span>
                  <span>Paste one or more questions from your spreadsheet (copy directly from Excel or Google Sheets)</span>
                </li>
                <li className="flex gap-3">
                  <span className="font-medium text-blue-600">2.</span>
